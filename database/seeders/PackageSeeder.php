    ...
    public function run(): void
    {
        $packages = [
            [
                ...
                'capabilities'  => ['custom_certificate'],
                'max_persons'   => 100,
                'max_members'   => 5,
                'color'         => '#A08070',
                'is_featured'   => false,
            ...
            [
                ...
                'price_yearly'  => 490,
                'currency'      => 'SAR',
                'features'      => ['كل مزايا المجاني', 'حتى 5000 شخص', 'أعضاء غير محدودين', 'تصدير البيانات', 'دعم بأولوية'],
                'capabilities'  => ['custom_certificate', 'data_export', 'priority_support'],
                'max_persons'   => 5000,
                'max_members'   => null,
                'color'         => '#8B6914',
                'is_featured'   => true,
            ...
            [
                ...
                'price_yearly'  => 1990,
                'currency'      => 'SAR',
                'features'      => ['كل مزايا الاحترافي', 'أشخاص غير محدودين', 'نطاق فرعي مخصّص', 'مدير حساب مخصّص'],
                'capabilities'  => ['custom_certificate', 'data_export', 'priority_support', 'custom_subdomain', 'account_manager'],
                'max_persons'   => null,
                'max_members'   => null,
                'color'         => '#3D2B1F',
                'is_featured'   => false,
